...
┌════════════════════┐
█ [${blanco}01${verde}] ┃ ${blanco}Facebook${verde}    █
█════════════════════█
█ [${blanco}02${verde}] ┃ ${blanco}Netflix${verde}     █
█════════════════════█
█ [${blanco}03${verde}] ┃ ${blanco}PayPal${verde}      █
█════════════════════█
█ [${blanco}04${verde}] ┃ ${blanco}Instagram${verde}   █
█════════════════════█
█ [${blanco}05${verde}] ┃ ${blanco}Spotify${verde}     █
█════════════════════█
█ [${blanco}06${verde}] ┃ ${blanco}Snapchat${verde}    █
█════════════════════█
█ [${blanco}07${verde}] ┃ ${blanco}Microsoft${verde}   █
█════════════════════█
█ [${blanco}08${verde}] ┃ ${blanco}Google${verde}      █
█════════════════════█
█ [${blanco}09${verde}] ┃ ${blanco}Falsify${verde}     █
└════════════════════┘
┃
└═>>> "${blanco}
