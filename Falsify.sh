...
${verde}┌════════════════════┐
${verde}█ [${blanco}01${verde}] ┃ ${blanco}Facebook${verde}    █
${verde}█════════════════════█
${verde}█ [${blanco}02${verde}] ┃ ${blanco}Netflix${verde}     █
${verde}█════════════════════█
${verde}█ [${blanco}03${verde}] ┃ ${blanco}PayPal${verde}      █
${verde}█════════════════════█
${verde}█ [${blanco}04${verde}] ┃ ${blanco}Instagram${verde}   █
${verde}█════════════════════█
${verde}█ [${blanco}05${verde}] ┃ ${blanco}Spotify${verde}     █
${verde}█════════════════════█
${verde}█ [${blanco}06${verde}] ┃ ${blanco}Snapchat${verde}    █
${verde}█════════════════════█
${verde}█ [${blanco}07${verde}] ┃ ${blanco}Microsoft${verde}   █
${verde}█════════════════════█
${verde}█ [${blanco}08${verde}] ┃ ${blanco}Google${verde}      █
${verde}█════════════════════█
${verde}█ [${blanco}09${verde}] ┃ ${blanco}Falsify${verde}     █
${verde}└════════════════════┘
┃
└═>>> "${blanco}
